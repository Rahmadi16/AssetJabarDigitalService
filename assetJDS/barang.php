...
<html lang="en">
                    ...
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        if (isset($_POST['move_data'])) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                ...
                                $insert_sql = "INSERT INTO barang_keluar (kode_barang, nama_barang, merk, spesifikasi, no_jumlah, no_mesin, no_polisi, tahun_perolehan, satuan, volume, harga_satuan, keterangan, u_ekonomis, akum_2020, akum_2021, beban_2021) VALUES ('$kode_barang', '$nama_barang', '$merk', '$spesifikasi', '$no_jumlah', '$no_mesin', '$no_polisi', '$tahun_perolehan', '$satuan', '$volume', '$harga_satuan', '$keterangan', '$u_ekonomis', '$akum_2020', '$akum_2021', '$beban_2021')";
                                if ($conn2->query($insert_sql) !== TRUE) {
                                    echo "Error saat memasukkan data: " . $conn2->error;
                                }
                            }

                            $delete_sql = "DELETE FROM barang";
    ...
    function deleteData() {
        ...
        // Setelah penghapusan berhasil, Anda bisa memanggil fungsi untuk memindahkan data ke halaman "barang_keluar"
        // Contoh: window.location.href = 'barang_keluar.php?idx=' + deleteRowIdx + '&reason=' + encodeURIComponent(reason);
    }
</script>
