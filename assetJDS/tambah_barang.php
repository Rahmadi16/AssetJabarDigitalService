    ...
    <div class="modal-dialog">
        ...
        <div class="form-group">
            ...
            <select name="kode_barang" id="kode_barang" class="custom-select form-control">
                ...
                <option value="1.3.2.02.01.02.003">1.3.2.02.01.02.003</option>
                <option value="1.3.2.02.01.04.001">1.3.2.02.01.04.001</option>
                <option value="1.3.2.06.01.02.133">1.3.2.06.01.02.133</option>
                <option value="1.3.2.05.02.06.074">1.3.2.05.02.06.074</option>
                <option value="1.3.2.10.01.01.001">1.3.2.10.01.01.001</option>
                <option value="1.3.2.05.02.06.012">1.3.2.05.02.06.012</option>
                <option value="1.3.2.10.02.04.024">1.3.2.10.02.04.024</option>
            </select>
        </div>
        <div class="form-group">
            <label for="nama_barang" >Nama Barang</label>
            <select name="nama_barang" id="nama_barang" class="custom-select form-control">
            </select>
        </div>
        ...
        document.getElementById("kode_barang").addEventListener("change", function() {
            ...
            var namaBarangSelect = document.getElementById("nama_barang");
            ...
            switch (selectedKodeBarang) {
                case "1.3.2.02.01.02.003":
                    selectedNamaBarang = "Mini Bus";
                    break;
                case "1.3.2.02.01.04.001":
                    selectedNamaBarang = "Sepeda Motor";
                    break;
                case "1.3.2.06.01.02.133":
                    selectedNamaBarang = "Monitor/Televisi";
                    break;
                case "1.3.2.05.02.06.074":
                    selectedNamaBarang = "Access Bracket";
                    break;
                case "1.3.2.10.01.01.001":
                    selectedNamaBarang = "Video Wall Controler / Server";
                    break;
                case "1.3.2.05.02.06.012":
                    selectedNamaBarang = "Wireless";
                    break;
                case "1.3.2.10.02.04.024":
                    selectedNamaBarang = "Switch";
                    break;
            }
            ...
            if (selectedNamaBarang !== "") {
                ...
                option.value = selectedNamaBarang;
                option.textContent = selectedNamaBarang;
